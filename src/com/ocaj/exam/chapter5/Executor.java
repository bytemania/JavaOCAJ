...
public static final double PI = 3.14;
	...
	public static void main(String[] args) {
		...
		System.out.println("mTools.findLowerValue(x,y):" + mTools.findLowerValue(x,y));
		...
		childClass = new ChildClass("An useful String example");
		
		System.out.println("childClass.className():" +childClass.className() );
	
		System.out.println("Tools.formatDate():" + Tools.formatDate());
